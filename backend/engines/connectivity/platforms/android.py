...
class AndroidConnectivityPlatform(ConnectivityPlatform):
    """Android connectivity platform adapter."""

    platform_name = "ANDROID"

    def capabilities(self) -> Dict[str, bool]:
        """Return Android connectivity capabilities."""
    ...
    def connectivity(self) -> Dict[str, object]:
        """Return Android connectivity information."""
    ...
    def scan_networks(self) -> List[VisibleNetwork]:
        """Return Android scan data supplied by the native client."""
    ...
    def ingest_native_scan(
        ...
        """Convert approved native Android scan data."""
